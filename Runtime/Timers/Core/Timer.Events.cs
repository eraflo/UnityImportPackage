...
namespace Eraflo.Catalyst.Timers
{
    ...
    public partial class Timer
    {
        ...
        public void On<TCallback>(TimerHandle handle, Action callback) 
        ...
        public void On<TCallback, TArg>(TimerHandle handle, Action<TArg> callback) 
            where TCallback : struct, ITimerCallback
        {
        ...
        /// <param name="handle">Timer handle.</param>
        public void Off<TCallback>(TimerHandle handle) 
            where TCallback : struct, ITimerCallback
        {
