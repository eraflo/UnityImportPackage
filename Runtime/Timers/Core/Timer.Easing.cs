...
namespace Eraflo.Catalyst.Timers
{
    ...
    public partial class Timer
    {
        ...
        public float GetEasedProgress(TimerHandle handle, EasingType easing)
        {
        ...
        public float Lerp(TimerHandle handle, float from, float to, EasingType easing = EasingType.Linear)
        {
        ...
        /// </summary>
        public Vector2 Lerp(TimerHandle handle, Vector2 from, Vector2 to, EasingType easing = EasingType.Linear)
        {
            float t = GetEasedProgress(handle, easing);
        ...
        /// </summary>
        public Vector3 Lerp(TimerHandle handle, Vector3 from, Vector3 to, EasingType easing = EasingType.Linear)
        {
            float t = GetEasedProgress(handle, easing);
        ...
        /// </summary>
        public Quaternion Lerp(TimerHandle handle, Quaternion from, Quaternion to, EasingType easing = EasingType.Linear)
        {
            float t = GetEasedProgress(handle, easing);
        ...
        /// </summary>
        public Color Lerp(TimerHandle handle, Color from, Color to, EasingType easing = EasingType.Linear)
        {
            float t = GetEasedProgress(handle, easing);
        ...
        /// </summary>
        public float LerpUnclamped(TimerHandle handle, float from, float to, EasingType easing = EasingType.Linear)
        {
            float t = GetEasedProgress(handle, easing);
        ...
        /// </summary>
        public Vector3 LerpUnclamped(TimerHandle handle, Vector3 from, Vector3 to, EasingType easing = EasingType.Linear)
        {
            float t = GetEasedProgress(handle, easing);
